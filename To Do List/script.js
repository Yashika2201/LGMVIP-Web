window.addEventListener('load', () => {
    ...
    const date = new Date();
    currDate.innerText = date.getDate()  + '/' + (date.getMonth() + 1) + '/' + date.getFullYear() ;
    currDay.innerText = new Date().toLocaleString('en-us', {  weekday: 'long' });
    ...
    form.addEventListener('submit', (e) => {
        ...
        task_input.classList.add('readonly');
